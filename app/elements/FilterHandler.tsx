...
export default function FilterHandler() 
{
  ...
  return (
    ...
    <div className="w-[100%] flex items-center justify-center mt-6 p-2">
      <form action={AddFilter} className="flex flex-col min-w-[80%] max-w-[100%]">
        <div className="flex flex-1 min-w-[60%] max-w-[100%] rounded-md text-center focus:outline-none focus:ring-2 focus:ring-violet-500 hover:bg-blue-800 shadow-md">
          ...
          <button type="submit" className="flex flex-1 px-2 py-2 bg-linear-to-br from-purple-200 to-fuchsia-300 text-gray-900 rounded-r-md focus:outline-none focus:ring-2 focus:ring-violet-500 hover:bg-blue-800 shadow-md">
